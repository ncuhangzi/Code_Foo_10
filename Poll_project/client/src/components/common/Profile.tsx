...
import { ProfileProps, PollProps } from "interfaces/common";
...
const Profile = ({ type, name, avatar, email, polls }: ProfileProps) => (
    <Box>
                                ...
                                <Stack gap="15px">
                                    ...
                                    >
                                        ...
                                        <Typography
                                            ...
                                            color="#11142D"
                                        >
                                            160 Pleasant St., Apt 806, Malden,
                                            Massachusetts 02148
                                        </Typography>
                                    </Box>
                                </Stack>
